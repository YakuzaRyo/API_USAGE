...
A Vue component that parses an arbitrary JSON response into leaf-node paths and renders them as clickable tags. Users click tags to auto-fill JSONPath mapping inputs, eliminating manual path typing.

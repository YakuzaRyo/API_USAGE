...
Category creation and editing via a 2-step wizard component, enabling logo upload during creation and providing a guided flow consistent with the ProviderWizard pattern.

...
A collapsible sidebar navigation that toggles between expanded and collapsed states, persisting user preference in localStorage and triggering chart resizes on transition.

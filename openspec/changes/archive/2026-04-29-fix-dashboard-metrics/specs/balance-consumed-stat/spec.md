...
### Requirement: Balance consumed stat card remains unchanged
The Dashboard SHALL continue to display a stat card showing the total balance consumed amount, styled identically to the existing cards. The card label and position do not change.
